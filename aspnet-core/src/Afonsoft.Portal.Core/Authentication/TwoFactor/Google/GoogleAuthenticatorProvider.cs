...
namespace Afonsoft.Portal.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PortalServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Afonsoft.Portal", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
