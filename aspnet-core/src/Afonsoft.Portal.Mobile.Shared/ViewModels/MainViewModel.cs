...
using Afonsoft.Portal.Controls;
using Afonsoft.Portal.Dto;
using Afonsoft.Portal.Extensions;
using Afonsoft.Portal.Localization;
using Afonsoft.Portal.UI;
using Afonsoft.Portal.UI.Assets;
using Afonsoft.Portal.Views;
using DependencyResolver = Afonsoft.Portal.Core.Dependency.DependencyResolver;
